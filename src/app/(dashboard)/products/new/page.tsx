...
import { ArrowLeft, Save, Package, Tag, DollarSign, Percent, FileText, FolderOpen, Clock, Receipt } from "lucide-react";
...
export default function NewProductPage() {
  ...
  useEffect(() => {
    fetch("/api/product-categories").then((r) => r.ok && r.json()).then(setCategories).catch(() => {});
  }, []);
